...
--
INSERT INTO
  `comentario_acomodacao` (`acomodacao_id`, `usuario_id`, `comentario`)
VALUES
  (1, 1, 'Muito Confortavel'),
...
--
INSERT INTO
  `conforto_has_acomodacao` (`conforto_id`, `acomodacao_id`)
VALUES
  (1, 1),
  (1, 2),
  (3, 1),
